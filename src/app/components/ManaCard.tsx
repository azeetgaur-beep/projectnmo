...
export function ManaCard() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const starShine = gsap.timeline({ paused: true })
  ...
  return (
    <div 
      ...
      className="relative w-full max-w-lg aspect-[1.63/1] mx-auto perspective-1000 cursor-pointer"
      style={{ perspective: '1000px' }}
    >
      <div 
        className="w-full h-full transition-transform duration-200 ease-out preserve-3d drop-shadow-2xl"
        style={{ 
        ...
        >
          <defs>
            ...
            <clipPath id="txtBoxes">    
              <rect className="txtBox" x="40" y="40" width="150" height="45" />
              <rect className="txtBox" x="40" y="210" width="400" height="35" />
              <rect className="txtBox" x="40" y="260" width="200" height="25" />
              <rect className="txtBox" x="40" y="295" width="250" height="35" />
              <rect className="txtBox" x="460" y="280" width="120" height="50" />
            </clipPath>  
          ...
          <g mask="url(#cardMask)">
            {/* Mana Dark Navy Background */}
            <rect className="bg" fill="#000000" width="100%" height="100%"/>
            
            <g fill="none" stroke="#fff" strokeWidth="2" strokeDasharray="6 2 4 2.5 4 3 3.5 3" className="opacity-20">
            ...
            {/* Mana Accent Triangles */}
            <polygon id="tri1" fill="#F05C26" points="0,47 0,0 44,22"/>
            <polygon id="tri2" fill="#F05C26" points="0,47 0,0 44,22"/>    
            ...
            {/* Subtle Waves */}
            <g fill="#222222" className="opacity-50">
            ...
            <g fill="#F05C26" className="opacity-30">
            ...
            <g clipPath="url(#orbClip1)">
              <use href="#wave2" fill="#222222" />
              <use href="#wave1" fill="#000000" />      
            </g>
            ...
            <g fill="#fff" strokeLinecap="round">
              <g clipPath="url(#txtBoxes)">
                <text x="45" y="75" fontSize="34" fontFamily="serif" fontWeight="bold">Mana</text>
                <text x="45" y="240" fontSize="26" letterSpacing="4.5" fontFamily="monospace" fontWeight="500">4218 5520 8841 0274</text>
                <text x="45" y="275" fontSize="12" letterSpacing="1" fill="#aaa">VALID THRU <tspan fill="#fff" fontWeight="bold">09/30</tspan></text>
                <text x="45" y="320" fontSize="22" letterSpacing="1.5" fontWeight="600">MARIA SANTOS</text>    
                <text className="logoPt" x="460" y="320" fontSize="38" fontStyle="italic" fontWeight="900">VISA</text>    
              </g>
              ...
              <rect mask="url(#chipMask)" fill="#D4AF37" rx="5" ry="5" x="89" y="125" width="61" height="50.2"/>
            </g>
          </g>
        </svg>
      </div>
